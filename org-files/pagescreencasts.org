...
This page contains the screencasts for the first part of the course [[file:index.org::*Course description][Seminar Datascience for Economics]]
...
*Python*: you have done the python track of [[https://janboone.github.io/applied-economics/index.html][Applied Economic Analysis]].
